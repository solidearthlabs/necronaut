...
Shader "Necronaut/Boss Shader"
{
	Properties
	{
		...
		_IntersectIntensity("Intersect Intensity", Range( 0 , 1)) = 1
		_IntersectColor("Intersect Color", Color) = (0.7352941,0.06487891,0.2174562,1)
		_HitPosition("Hit Position", Vector) = (0,0,0,0)
		_HitTime("Hit Time", Range( 0 , 10)) = 0
		_HitColor("Hit Color", Color) = (1,1,1,1)
		_HitSize("Hit Size", Range( 0 , 1)) = 0.366275
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float simplePerlin3D66 = snoise( ( float4( ase_vertexNormal , 0.0 ) + ( ShieldSpeed84 / _Float1 ) ).xyz );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float fresnelFinalVal8 = (0.0 + 1.0*pow( 1.0 - dot( ase_worldNormal, worldViewDir ) , (10.0 + (ShieldRimPower32 - 0.0) * (0.0 - 10.0) / (10.0 - 0.0))));
			float ShieldRim23 = fresnelFinalVal8;
...
/*ASEBEGIN
Version=12101
251;26;1278;656;4157.032;-553.6391;1.6;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-3674.017,-1545.944;Float;False;Property;_ShieldAnimSpeed;Shield Anim Speed;10;0;3;-10;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.Vector3Node;136;-3624.635,276.1571;Float;False;Property;_HitPosition;Hit Position;15;0;0,0,0;0;4;FLOAT3;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;140;-3632.337,-259.7433;Float;False;Property;_HitSize;Hit Size;18;0;0.366275;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;138;-3595.025,-162.8425;Float;False;Property;_HitColor;Hit Color;17;0;1,1,1,1;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-1956.507,-905.8556;Float;False;Property;_ShieldRimPower;Shield Rim Power;9;0;7;0;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;137;-3157.953,205.9713;Float;False;Property;_HitTime;Hit Time;16;0;0;0;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-3430.724,1320.123;Float;False;Property;_IntersectIntensity;Intersect Intensity;13;0;1;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-1628.587,-0.2153163;Float;False;Property;_Float1;Float 1;8;0;5;1;10;0;1;FLOAT
...
Node;AmplifyShaderEditor.ColorNode;122;-2961.037,841.2547;Float;False;Property;_IntersectColor;Intersect Color;14;0;0.7352941,0.06487891,0.2174562,1;0;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.RangedFloatNode;102;-1432.937,42.85229;Float;False;Property;_ShieldDistortion;Shield Distortion;12;0;0.01;0;0.03;0;1;FLOAT
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-551.0419,-1550.427;Float;False;True;2;Float;ASEMaterialInspector;0;Standard;Necronaut/Boss Shader;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;Back;1;7;False;0;0;Transparent;0.5;True;True;0;False;Transparent;Transparent;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;False;0;255;255;0;0;0;0;False;0;4;10;25;False;0.5;True;0;Zero;Zero;0;Zero;Zero;Add;Add;0;False;0;0,0,0,0;VertexOffset;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;0;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0.0;False;4;FLOAT;0.0;False;5;FLOAT;0.0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0.0;False;9;FLOAT;0.0;False;10;OBJECT;0.0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=745BD5BE685ED65E7CA6539C0B96A920CE773EED